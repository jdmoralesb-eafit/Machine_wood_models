...
BASE_OUTPUT_DIR = "machine_models_characteristics_80"
...
def main():
    ...
    columns_to_drop = [
        'Source', 'Family', 'Genus', 'Specific epithet', 'Species',
        'sp_clean', 'species', 'error_relativo', 'info_bioma', 
        'ranking_bioma', 'species_clean'
    ]
    
    
    species_cols = [col for col in df.columns if 'Species_1' in col]
    columns_to_drop.extend(species_cols)
